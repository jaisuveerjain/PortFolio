      ...
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Jai Suveer Jain</h3>
            <p className="text-base leading-7 text-about_me_green">Software Engineer</p>
              ...
              >
                ...
                <div className="border-y py-2 border-gray-500/30 mb-6">
                  <div className="flex flex-wrap gap-x-6">
                    ...
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">German</p> - <p className="text-gray-500">Limited Working Proficiency</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
            ...
            >
              <GlowCard className="hover:shadow-about_me_green/90" glowClassName="from-[#6bc072] to-[#6bc072]">
                <div className="flex flex-col gap-8 @lg:flex-row justify-between">
                  ...
                  <div className="max-w-xl flex-auto">
                    <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">MSc. in Data Analytics</h3>
                    <p className="text-base leading-7 text-about_me_green">University for Creative Arts</p>
                  </div>
                </div>
              </GlowCard>
            </FadeIn>
